 ...
 *
 * Displays a heading, a description, and a responsive grid of movie cards.
 * Each movie card links to its detail page and shows its name, poster, and classification.
 *
 * @component
